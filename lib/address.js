...
function Address(data, network, type) {
  ...
  info.network = Networks.get(network) || info.network || Networks.defaultNetwork;
...
Address._transformBuffer = function(buffer, network, type) {
  ...
  if (network){ // This will fix the problem when detecting `regtest`
      bufferVersion.network = network;
  }
